...
import { FeaturedProduct } from "./_constant/Product";
...
const FeaturedProducts = () => {
  ...
  return (
    <section className="relative px-4 md:px-20 lg:px-4 2xl:px-20 lg:pr-0 2xl:pr-20 pt-16 min-h-screen bg-gradient-to-b from-white to-gray-50">
      {/* Decorative background elements */}
      <div className="absolute inset-0 -z-10">
        {/* <div className="absolute right-0 bottom-0 w-[400px] h-[700px] bg-[#FBF4E7]/30 rounded-full blur-3xl" /> */}
        {/* <div className="absolute left-1/4 top-1/4 w-[300px] h-[300px] bg-wine/5 rounded-full blur-2xl" /> */}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          <div className="max-w-md">
            ...
            <motion.h1
              variants={itemVariants}
              className="text-3xl md:text-5xl mb-4 text-wine font-serif"
            >
        ...
        <div className="lg:col-span-9 relative">
                  ...
                  <div className="p-4">
                    ...
                    {i === 0 && (
                      <div className="absolute top-6 left-6 z-10">
                        <div className="flex items-center gap-1 bg-wine/10 backdrop-blur-sm px-3 py-1 rounded-full">
          ...
          {/* Background shape */}
          <div className="hidden lg:block w-[96.5%] h-[700px] absolute bg-[#FBF4E7] left-12 top-0 z-0 rounded-3xl" />
        </div>
      </div>
    </section>
  );
